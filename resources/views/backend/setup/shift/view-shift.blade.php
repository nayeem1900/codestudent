                    ...
                    <section class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3>Shift List
                                    @if($access_action->student_shift_act)
                                    <a class="btn btn-success float-right btn-sm" href="{{route('setups.student.shift.add')}}"><i class="fa fa-plus-circle"></i> Add Shift</a>
                                    @endif
                                </h3>
                                ...
                                <table id="example1" class="table table-bordered table-hover">
                                    ...
                                    @foreach($allData as $key=>$value)
                                        <tr>
                                            ...
                                            @if($access_action->student_shift_act)
                                            <td>
                                                <a title="Edit" class="btn btn-sm btn-primary" href="{{route('setups.student.shift.edit',$value->id)}}"><i class="fa fa-edit"></i></a>
