                    ...
                    <section class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3>Year List
                                    @if($access_action->view_year_act)
                                    <a class="btn btn-success float-right btn-sm" href="{{route('setups.student.year.add')}}"><i class="fa fa-plus-circle"></i> Add Year</a>
                                    @endif
                                </h3>
                                ...
                                <table id="example1" class="table table-bordered table-hover">
                                    ...
                                    @foreach($allData as $key=>$value)
                                        <tr>
                                            ...
                                            @if($access_action->view_year_act)
                                            <td>
                                                <a title="Edit" class="btn btn-sm btn-primary" href="{{route('setups.student.year.edit',$value->id)}}"><i class="fa fa-edit"></i></a>
